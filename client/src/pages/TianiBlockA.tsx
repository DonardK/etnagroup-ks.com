...
const apartments: Apartment[] = [
  ...
  { name: 'A-90.2 m²', area: '90.2 m²', pdfPath: `${BASE}/Tiani-A-90.2m²-2.pdf` },
  ...
  { name: 'A-94.4 m²', area: '94.4 m²', pdfPath: `${BASE}/Tiani-A-94.4m²-2.pdf` },
  { name: 'A-94.4 m²', area: '94.4 m²', pdfPath: `${BASE}/Tiani-A-94.4m²-3.pdf` },
