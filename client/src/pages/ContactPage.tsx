          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'error' && (
                ...
                >
                  {t.contact.errorDetail}
                </motion.div>
              )}
            </form>
          </motion.div>

          {/* Contact Information — unchanged layout */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            className="space-y-8"
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="rounded-full bg-[#657432]/20 p-3">
                    <svg className="h-6 w-6 text-[#657432]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="rounded-3xl bg-[#F8F2DD] p-8 shadow-xl border border-[#657432]/20">
              ...
              <div className="flex gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="flex h-12 w-12 items-center justify-center rounded-full bg-[#657432] text-[#F8F2DD]"
                >
