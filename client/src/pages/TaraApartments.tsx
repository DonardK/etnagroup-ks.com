...
const apartments: Apartment[] = [
  ...
  { name: '64.3 m² (variant)', area: '64.3 m²', pdfPath: `${BASE}/-64.3 m2.pdf` },
  { name: '64.3 m² (variant 2)', area: '64.3 m²', pdfPath: `${BASE}/64.3- m2.pdf` },
  { name: '64.30 m²', area: '64.30 m²', pdfPath: `${BASE}/64.30 m2.pdf` },
  { name: '64.30 m² (variant)', area: '64.30 m²', pdfPath: `${BASE}/64.30. m2.pdf` },
  ...
  { name: '76.7 m² (variant)', area: '76.7 m²', pdfPath: `${BASE}/76.7 - m2.pdf` },
  ...
  { name: '91.20 m² (variant)', area: '91.20 m²', pdfPath: `${BASE}/91.20 m2-.pdf` },
