...
export const QrCodePage = () => {
  ...
  const links = useMemo(
    () => [
      ...
      {
        label: t.qr.phone,
        href: 'tel:+38346383838',
        description: '+383 46 38 38 38',
        external: false,
        icon: phoneIcon,
      },
      {
        label: t.qr.officePrishtina,
        href: 'https://maps.app.goo.gl/2EZKH6iwTVxrX8eZ8',
        description: t.qr.openMaps,
        external: true,
        icon: mapIcon,
      },
      {
        label: t.qr.officePrizren,
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#F8F2DD] px-6 py-12">
      ...
      >
        <div className="mb-10 text-center">
          ...
          />
          <h1 className="text-3xl font-bold text-[#657432]">{t.common.brandName}</h1>
          <p className="mt-2 text-[#657432]/70">{t.qr.tagline}</p>
        </div>
